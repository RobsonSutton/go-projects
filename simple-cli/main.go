...
func main() {
	...
	for remainingTickets > 0 {
		...
		isValidName, isValidEmail, isValidNoOfTickets := helper.ValidateUserInput(firstName, lastName, email, userTickets, remainingTickets)
		...
		if isValidName && isValidEmail && isValidNoOfTickets {
			...
			if !isValidEmail {
				fmt.Println("email address does not contain an @ sign")
			}
